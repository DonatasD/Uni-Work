...
/**
 * <p>
 * A suite of tests, run with {@link org.jboss.arquillian Arquillian} to test the JAX-RS endpoint for Contact creation
 * functionality (see {@link ContactRESTService#createContact(Contact) createContact(Contact)}).
 * </p>
 *
 * @author balunasj
...
public class ContactRegistrationTest {
     ...
     * <p/>
     * <p>
     * Note: This code will be needed at the start of each Arquillian test, but should not need to be edited, except to pass
     * *.class values to .addClasses(...) which are appropriate to the functionality you are trying to test.
     * </p>
     *
    ...
    /**
     * <p>
     * A utility method to construct a {@link org.jboss.quickstarts.wfk.contact.Contact Contact} object for use in testing. This
