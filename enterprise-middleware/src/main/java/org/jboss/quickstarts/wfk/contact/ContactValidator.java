...
public class ContactValidator {
    ...
    /**
     * <p>
     * Validates the given Contact object and throws validation exceptions based on the type of error. If the error is standard
     ...
     */
    void validateContact(Contact contact) throws ValidationException {
     ...
     * <p/>
     * <p>
     * Since Update will being us an email that is already in the database we need to make sure that it is the email from the
