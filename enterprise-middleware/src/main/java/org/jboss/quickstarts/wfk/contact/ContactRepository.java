...
/**
 * <p/>
 * This is a Repository class and connects the Service/Control layer (see {@link ContactService} with the Domain/Entity Object
 * (see {@link Contact}).
 * <p/>
 * <p/>
 * <p/>
...
public class ContactRepository {
    ...
    Contact delete(Contact contact) throws Exception {
        ...
        if (contact.getId() != null) {
             ...
             * 
             * Merge sees that the object has a primary key (id), so it knows it is not new and must hit the database to
             * reattach it.
             * 
             * Note, there is NO remove method which would just take a primary key (id) and a entity class as argument. You
             * first need an object in a persistent state to be able to delete it.
             * 
